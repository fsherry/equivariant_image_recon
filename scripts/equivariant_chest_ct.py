...
from equivariant_ip.ct.geometries import generate_geometry_params
...
feat_type = e2cnn.nn.FieldType(base_space,
                               args.channels * [base_space.regular_repr])

with open('/nfs/st01/hpc-cmih-cbs31/fs436/LIDC-IDRI/sparse_params.json',
          'r') as in_file:
    params = json.load(in_file)

with open('/nfs/st01/hpc-cmih-cbs31/fs436/LIDC-IDRI/sparse_geometries',
          'rb') as in_file:
...
proximal_constructor = lambda: PrimalProximalEquivariant(
    conv_params,
    in_channels=1,
